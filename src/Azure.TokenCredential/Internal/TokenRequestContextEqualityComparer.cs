...
internal sealed class TokenRequestContextEqualityComparer : IEqualityComparer<TokenRequestContext>
{
    internal static readonly TokenRequestContextEqualityComparer Instance
        =
        new();

    private TokenRequestContextEqualityComparer()
    {
    }
